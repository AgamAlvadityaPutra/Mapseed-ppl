...
<main
    ...
    <form action="/edit-wilayah?wilayah={{ $wilayah }}&lat={{ $coord['lat'] }}&lng={{ $coord['lng'] }}"
        ...
        <div class="w-full">
            <input type="text" id="luas_lahan" name="luas_lahan"
                ...
                value="{{ old('luas_lahan') ? old('luas_lahan') : $dataWilayah['luas_lahan'] }}" />
        ...
        <input type="text" id="topografi" name="topografi" class="w-full p-2 border border-gray-300 rounded-md"
            value="{{ old('topografi') ? old('topografi') : $dataWilayah['topografi'] }}" />
        ...
        <input type="text" id="tipe_tanah" name="tipe_tanah" class="w-full p-2 border border-gray-300 rounded-md"
            value="{{ old('tipe_tanah') ? old('tipe_tanah') : $dataWilayah['tipe_tanah'] }}" />
        <label for="kondisi_iklim">Kondisi Iklim</label>
        <input type="text" id="kondisi_iklim" name="kondisi_iklim"
            class="w-full p-2 border border-gray-300 rounded-md"
            value="{{ old('kondisi_iklim') ? old('kondisi_iklim') : $dataWilayah['kondisi_iklim'] }}" />
        <label for="kesuburan_tanah">Kesuburan Tanah</label>
        <input type="text" id="kesuburan_tanah" name="kesuburan_tanah"
            class="w-full p-2 border border-gray-300 rounded-md"
            value="{{ old('kesuburan_tanah') ? old('kesuburan_tanah') : $dataWilayah['kesuburan_tanah'] }}" />
        ...
        <input type="text" id="drainase" name="drainase" class="w-full p-2 border border-gray-300 rounded-md"
            value="{{ old('drainase') ? old('drainase') : $dataWilayah['drainase'] }}" />
        ...
        <div>
            <input type="text" id="rekomendasi_tanaman" name="rekomendasi_tanaman"
                class="w-full p-2 border border-gray-300 rounded-md"
                value="{{ old('rekomendasi_tanaman') ? old('rekomendasi_tanaman') : $dataWilayah['rekomendasi_tanaman'] }}" />
        ...
        <div class="relative w-full h-80">
            <input type="file" name="foto_wilayah" id="foto_wilayah"
                ...
                accept=".jpg,.jpeg,png" />
            <img class="w-full h-full object-cover" id="foto_wilayah_preview"
                src="/storage/{{ $dataWilayah['foto_wilayah'] }}">
            <div class="hidden w-full h-full flex-col gap-4 items-center justify-center border-4 border-dashed"
        ...
        <div class="w-full flex gap-4 mt-4 justify-end">
            ...
            <a href="/pemetaan?lat={{ $coord['lat'] }}&lng={{ $coord['lng'] }}" type="button"
